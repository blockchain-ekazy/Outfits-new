        ...
        <div className="home_banner HeadHome" id="home">
            ...
            <a id='Mint'></a>
                ...
                <div className="home_banner_text" data-aos="fade-up" data-aos-duration="1000">
                    <h5 className='text-white'>Bringing digital apparel, accessories, and fashion to NFTs and the metaverse</h5>
                    <h3><em>World</em> OF Outfits</h3>
                    <p>To get started, first claim a body, then mint an outfit</p>
                    <div className="btn_flex">
                        <div className="btn_flex_inner"><a href="" className="btn py-2">
                            {/* <img src="img/btn_img2.png" title="" alt=""/> */}
                            Mint An Outfits <br/> .05 eth </a>
                        </div>
                        <div className="btn_flex_inner p-0"><a href="" className=" py-2 btn">
                            {/* <img src="img/btn_img2.png" title="" alt=""/> */}
                            Claim a Body <br/> Free + Gas </a>
                        </div>
                    </div>
                </div>
            </div>
